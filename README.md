...
> 版本：v1.2 · 2026-07-13
> 唯一口径：Skillver 已**全面开放注册**；**邀请码仅用于社群参与**，不再作为注册门槛。GEO 按当前真实能力与进展执行，不得再宣传「需邀请码才能注册」。
...
- **允许**：全面开放注册、自助注册、无需邀请码即可注册；邀请码仅用于社群 / 社群邀请码等表述。
- **禁止**：把当前阶段写成仍需邀请码才能注册，或仍处于封闭内测准入。
- **待核实**：费用、具体体验或名额数量、导师服务状态；业务事实源确认前不得当作既成事实新增或发布。
