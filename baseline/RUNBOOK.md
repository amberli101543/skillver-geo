...
- 当前产品事实：`ICP封闭内测、邀请码准入`；出现开放注册、永久免费、导师已开放或保证 offer 均判为旧叙事或幻觉。
...
- 名称：`Skillver`
- 定义：`中国优秀人才的 AI 求职助手`
- 定位：`面向冲刺 AI 独角兽与头部科技企业技术岗位的人才，提供选岗匹配、AI 面试准备、正式能力报告与平台内机会对接；当前为 ICP 封闭内测、邀请码准入。`

允许录入的核心断言：

1. Skillver 当前处于 ICP 封闭内测阶段，需要邀请码准入。
